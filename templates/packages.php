...
// Build enroll URLs - Using home_url() with query parameters
$student_enroll_url = home_url('/?pz_enroll=student');
$school_enroll_url = home_url('/?pz_enroll=school');

// Debug: Uncomment to check URLs
// echo '<!-- Student URL: ' . $student_enroll_url . ' -->';
// echo '<!-- School URL: ' . $school_enroll_url . ' -->';
?>
